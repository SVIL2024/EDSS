...
parser.add_argument('--model-path', default='model/best_ucf.pth')
...
parser.add_argument('--test-every', default=10, type=int,
                    help='run the evaluation every N optimisation steps')
...
parser.add_argument('--bet-weight1', default=0.0, type=float,
                    help='weight of the betting MIL loss on the C-branch (UCF metric)')
...
parser.add_argument('--bet-lr', default=2e-3, type=float,
...
parser.add_argument('--ebh-neg-frac', default=0.0, type=float,
                    help='fraction of the lowest-evidence snippets of an ANOMALOUS '
                         'video to supervise as normal (confident negatives)')
...
parser.add_argument('--ebh-null-align', default=0.0, type=float,
                    help='weight of the null-alignment loss: pull the e-BH '
                         'non-selected bulk of anomalous videos toward the '
                         'normal-video null (mu, sigma), repairing the +2.00 '
                         'sigma null mis-specification (docs/LIMITATIONS.md)')
parser.add_argument('--dump-run-best', default='', type=str,
                    help='path to dump the run-best weights at the end of '
                         ...
                         'checkpoint); used to measure FDR/calibration of '
                         'runs that did not beat the global best')
